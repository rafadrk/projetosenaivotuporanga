...
include "../../model/permissions.php"; //SERVE PARA VERIFICAR SE PODE ACESAR A PAGINA.





//POR FAVOR COLOQUE SEU SCRIPT AQUI E NÃO DELETE AS DUAS PRIMEIRAS E DUAS ULTIMAS LINHAS.
