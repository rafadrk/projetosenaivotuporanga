...
<html lang="pt-br">
    ...
    <body>
        <div class="container">
            <div class="screen2">
                    <form class="login" method="post" action="cadastro_seguranca.php">
                        ...
                        if((!isset($_SESSION['ni']) == true) and (!isset($_SESSION['ni_maquina']) == true)){
                            ...
                            echo'<br><select name="professor" required>';
                            ...
                            echo '<h2>↪Checklist de Segurança:</h2>';
                            ...
                            setor.id_set, setor.id_unidade, setor.setor_descricao,
                            unidade.id_uni, unidade.unidade_descricao, unidade.unidade_cidade, unidade.unidade_estado,
                            requisitos.id_requisitos, requisitos.id_tipos_requisitos, requisitos.id_tipo_maquina, requisitos.requisitos_ativo, requisitos.requisitos_topicos, requisitos.requisitos_subtopicos, requisitos.requisitos_operacional, requisitos.requisitos_seguranca, requisitos.requisitos_preventivo,
                            ...
                            and requisitos.id_tipo_maquina = $id_tipo_maquina
                            and requisitos.requisitos_seguranca = $requisitos_seguranca";
