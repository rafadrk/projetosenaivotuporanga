        ...
        <div class="container">
            <div class="screen">
                <div class="screen__content">
                    <form class="login"  method="post" action="../../controller/login_aluno/validacao_login.php">
                        <center><img src="../img/senai.png" width="80%"></center><br>
                       <div id="formulario">
                        <div class="login__field">
                            <span id="msgAlerta1"></span>
                            <i class="login__icon fas fa-user"></i>
                            <center><input type="text" maxlength="10" class="login__input" placeholder="Número da Matrícula do aluno" name="ni" required></center>
                            <br>
                        ...
                        <button class="button login__submit">
                            ...
                            <center><br><br><br><br><br><br><h6><a href="loginprofessor.php">Entre como Colaborador.</a>
                </div>
