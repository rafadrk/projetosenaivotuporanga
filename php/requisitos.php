...
?>
        ...
        <link rel="icon" type="image/png" href="https://senaivotuporanga.com.br/nr12/view/img/iconepag.png"/>
            ...
            <br>
                        ...
                        <label style="font-size: 20px;">Check Operacional(1 ) :<input type="checkbox" value="1" name="check1" class="checkgroup" required></label>

                        <label style="font-size: 20px;">Check Segurança(2) :<input type="checkbox" value="2" name="check2" class="checkgroup" required></label>

                        <label style="font-size: 20px;">Check Preventivo(3) :<input type="checkbox" value="3" name="check3" class="checkgroup" required></label>
...
include "../../model/connection.php";
    ...
    while( $registro = mysqli_fetch_array($resultado)){
        ...
        echo "<tr>";
        echo '<td scope="row" style="color:black"><input type="checkbox" value="'.$id_tipos_requisitos.'" name="check_tipos_requisitos['.$id.']" class="login__input">
        <input type="hidden" value="'.$id_tipos_requisitos.'" name="id_tipos_requisitos['.$id.']" class="login__input"></td>';
