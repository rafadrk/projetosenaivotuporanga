                        ...
                        if((!isset($_SESSION['ni']) == true) and (!isset($_SESSION['ni_maquina']) == true)){
                            ...
                            $to = 'deathyntc@hotmail.com';
                            $subject = 'Teste de Máquinas...';
                            $message = 'Máquina: ' . $tipo_maquina_nome . ' NI: ' . $ni_maquina . '' ;
                            $header = 'From: ' . $ni_maquina .  '-' . $tipo_maquina_nome . '@senainr12.com' . "\r\n" .
                                        'Reply-To: ' . $ni_maquina . '-' . $tipo_maquina_nome . '@senainr12.com';
