...
<div class="tabela" style="overflow-x: auto; width:100%;">
    <div class="titulo1" style="overflow-x: auto;">Histórico</div><br>
    Checklist Operacional  = 1<br>
    Checklist de Segurança = 2<br><br>

    <form method="POST" action="leitura_historico.php">
        <label for="data-inicial">Data Inicial:</label>
        <input style='margin-right: 5px' type="date" id="data-inicial" name="data_inicial">

        <label for="data-final">Data Final:</label>
        <input style='margin-right: 5px' type="date" id="data-final" name="data_final">
        ...
        <?php
            ...
            echo '<label>Selecione a turma:</label>
                    <select style="margin-right: 5px" name="turma_nome">
        ...
        while($registro = mysqli_fetch_array($resultado)){
            ...
            echo'<label>Selecione o Responsável:</label>
                <select name="professor" style="width:10%; margin-right: 5px;" required>';
        ...
        <button type="submit">Filtrar</button> <div style='color: red; display: inline;'>Por favor, selecione todos os campos para fitrar a busca.</div>
    ...
    <table id="tabela" class="display" style="overflow-x:auto; color:black; text-shadow: 10%;">
        <thead>
            <tr>
...
<?php
    ...
    if (isset($_POST['data_inicial']) && isset($_POST['data_final']) && isset($_POST['turma_nome']) && isset($_POST['professor'])){
        ...
        historico.id_historico, historico.id_matricula, historico.id_maquina, historico.id_requisitos, historico.nome_prof, historico.historico_data, historico.historico_hora, historico.historico_status,
        ...
        and turma.turma_nome = '$turma_nome' and historico.nome_prof = '$professor' order by historico.historico_data desc";
    ...
    $excelData .='<td> Nome</td>';
    $excelData .='<td> Turma</td>';
    $excelData .='<td> Curso</td>';
    $excelData .='<td> Máquina</td>';
    $excelData .='<td> Máquina Fabricante</td>';
    $excelData .='<td> Máquina Modelo</td>';
    $excelData .='<td> NI da máquina</td>';
    $excelData .='<td> Checklist</td>';
    $excelData .='<td> Operacional(1)</td>';
    $excelData .='<td> Segurança(2)</td>';
    $excelData .='<td> Data</td>';
    $excelData .='<td> Hora</td>';
    $excelData .='<td> Responsável</td>';
    ...
    while($registro = mysqli_fetch_array($resultado)){
        ...
        $excelData .="<td>". $nome_prof."</td>";
        $excelData .="<td>". $historico_status."</td>";
        $excelData .= "</tr>";

        $data_inicial_formatadaa = date('d-m-Y', strtotime($historico_data));
        ...
        echo "<tr>";
                    ...
                    echo "<td style='color:black'>".$data_inicial_formatadaa."</td>";
                    echo "<td style='color:black'>".$historico_hora."</td>";
                    echo "<td style='color:black'>".$nome_prof."</td>";
